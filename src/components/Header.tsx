...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center relative z-[60]">
            <img
              src={menuOpen ? "/images/logo/logo menu.png" : scrolled ? "/images/logo/logo menu.png" : "/images/logo/logo hero.png"}
              alt="Подушечная"
      ...
      {/* Мобильное меню — полноэкранное с плавной анимацией */}
      <div
        className={`fixed inset-0 z-[55] bg-white flex flex-col md:hidden transition-all duration-300 ${
      ...
      >
        ...
        <div className="px-6 pb-10 flex flex-col gap-4">
          ...
          <a
            href="#menu"
            className="w-full text-center px-4 py-4 bg-[var(--color-accent)] text-white font-medium rounded text-base"
            onClick={() => setMenuOpen(false)}
          >
            {t("order")}
          </a>
